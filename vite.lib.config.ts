  ...
  build: {
    ...
    lib: {
      entry: {
        ...
        testing: fileURLToPath(new URL("./src/lib/testing.ts", import.meta.url)),
        parse: fileURLToPath(new URL("./src/lib/parse-api.ts", import.meta.url)),
        email: fileURLToPath(new URL("./src/lib/email.ts", import.meta.url)),
        ingest: fileURLToPath(new URL("./src/lib/ingest.ts", import.meta.url)),
      },
      formats: ["es"],
    },
    rollupOptions: {
